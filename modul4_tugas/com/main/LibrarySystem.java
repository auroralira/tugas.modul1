...
public class LibrarySystem {
    ...
    public static void main(String[] args) {
        daftarBuku[i++] = new StoryBook("SB32F", "Malaikat Berhati Gelap", 17, "Story", "Lexie Xu");
        daftarBuku[i++] = new HistoryBook("HB324", "Sejarah Indonesia", 2, "History", "Moskov");
        daftarBuku[i++] = new TextBook("TB323", "Hujan", 4, "Text", "Tere Liye");

        // Mengisi daftar mahasiswa
        studentList.add(0, new Student("202310370311199", "Ridha Dewi", "Teknik","Industri"));
        studentList.add(1, new Student("202310370311200", "Lira Aurora", "Teknik","Informatika"));
        studentList.add(2, new Student("202310370311201", "Asa Saila", "Teknik","Sipil"));
        ...
        while (isRunning) {
            ...
            switch (choice) {
                case 1:
                    ...
                    String nimStudent = input.next();
                    input.nextLine();
                    while(true){
                        if (nimStudent.length() != 15 ) {
                            System.out.print("Nim Harus 15 Digit!!!\n");
                            System.out.print("Masukkan NIM : ");
                            nimStudent = input.nextLine();
